...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/home-outlined.svg
  SvgGenImage get homeOutlined =>
      const SvgGenImage('assets/icons/home-outlined.svg');

  /// File path: assets/icons/left.svg
  SvgGenImage get left => const SvgGenImage('assets/icons/left.svg');

  /// File path: assets/icons/new-board.svg
  SvgGenImage get newBoard => const SvgGenImage('assets/icons/new-board.svg');

  /// File path: assets/icons/profile-filled.svg
  SvgGenImage get profileFilled =>
      const SvgGenImage('assets/icons/profile-filled.svg');

  /// File path: assets/icons/profile-outlined.svg
  SvgGenImage get profileOutlined =>
      const SvgGenImage('assets/icons/profile-outlined.svg');
  ...
  /// File path: assets/icons/view-grid-filled.svg
  SvgGenImage get viewGridFilled =>
      const SvgGenImage('assets/icons/view-grid-filled.svg');

  /// File path: assets/icons/view-grid-outlined.svg
  SvgGenImage get viewGridOutlined =>
      const SvgGenImage('assets/icons/view-grid-outlined.svg');
